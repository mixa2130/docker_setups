...
В каком количестве изолированных сетевых контуров происходит транспорт запросов и ответов в случае взаимодействия
внешних клиентов с сервисом внутри service mesh?
